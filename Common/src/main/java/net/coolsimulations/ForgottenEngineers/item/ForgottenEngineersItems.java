...
public class ForgottenEngineersItems {
    ...
    //public static final FERegistration.FERegistryObject<Item> DISTRIBUTION_WISDOM = ITEMS.register(DISTRIBUTION_WISDOM_ID.getPath(), () -> new EngineeringWisdomItem(new Item.Properties().rarity(Rarity.UNCOMMON)setId(ResourceKey.create(Registries.ITEM, DISTRIBUTION_WISDOM_ID))));
    ...
    //public static final FERegistration.FERegistryObject<Item> ROUTER = ITEMS.register(ROUTER_ID.getPath(), () -> new Item(new Item.Properties().setId(ResourceKey.create(Registries.ITEM, ROUTER_ID))));
