...
public class ClientCombustorTooltip extends ClientRestorerTooltip {

    private static final Component BUNDLE_EMPTY_DESCRIPTION = Component.translatable("item." + ForgottenEngineersCommon.MOD_ID + "." + ForgottenEngineersItems.COMBUSTOR_ID.getPath() + ".empty.description");
    private final BundleContents contents;

    public ClientCombustorTooltip(final BundleContents contents) {
        super(contents);
