...
public class ClientFuelCarrierTooltip extends ClientRestorerTooltip {

    private static final Component BUNDLE_EMPTY_DESCRIPTION = Component.translatable("item." + ForgottenEngineersCommon.MOD_ID + "." + ForgottenEngineersItems.FUEL_CARRIER_ID.getPath() + ".empty.description");
    private final BundleContents contents;

    public ClientFuelCarrierTooltip(final BundleContents contents) {
        super(contents);
